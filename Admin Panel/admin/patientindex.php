...
<body>
    <div class="main">
            <div class="nav">
                <div class="color1"><a class="redtext" href="patientSA.php" style="color: white;">Book Appointment</a></div>
                <div class="color2"><a class="bluetext" href="patientWI.php" style="color: white;">Walk In Request</a></div>
            </div>
            ...
            <div class="logo">
             ...
             <div class="table">
                <div class="flex">
                    ...
                    <input type="search" name="" id="" placeholder="Search Doctor's Name">
                </div>
    ...
    <div class="brgy-location">
        ...
        <div class="footer-section">
            ...
            <div class="contact-page">
                <p><a href="contact.php">More info<span>></span></a></p>
            </div>
        </div>
